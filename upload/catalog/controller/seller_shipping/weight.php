	...
	public function index() {
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		            ...
		            $data['header'] = $this->load->controller('common/header');
								...
								if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/seller_shipping/weight.tpl')) {
						            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/seller_shipping/weight.tpl', $data));
						        } else {
						            $this->response->setOutput($this->load->view('default/template/seller_shipping/weight.tpl', $data));
						        }
	}
}
