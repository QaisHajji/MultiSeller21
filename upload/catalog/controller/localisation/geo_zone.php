...
class ControllerLocalisationGeoZone extends Controller {
	...
	protected function getList() {
		...
		if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/localisation/geo_zone_list.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/localisation/geo_zone_list.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/localisation/geo_zone_list.tpl', $data));
        }
	}
	...
	protected function getForm() {
		...
		if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/localisation/geo_zone_form.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/localisation/geo_zone_form.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/localisation/geo_zone_form.tpl', $data));
        }
	}
