                ...
                foreach ($products as $product) {
                    ...
                    foreach ($productresults as $productresult) {
                        if ($productresult['seller_id']) {
						                    ...
						                    'shipping_method' => $this->session->data['shipping_method_'.$productresult['product_id']]['title'],
						                    'shipping_code' => $this->session->data['shipping_method_'.$productresult['product_id']]['code'],
