...
class ControllerorderOrder extends Controller
{
    ...
    public function getForm()
    {
       ...
       if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/order/order_form.tpl')) {
                $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/order/order_form.tpl', $data));
            } else {
                $this->response->setOutput($this->load->view('default/template/order/order_form.tpl', $data));
            }
    }
    ...
    public function sellerhistory()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/order/order_sellerhistory.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/order/order_sellerhistory.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/order/order_sellerhistory.tpl', $data));
        }
    }
    ...
    public function invoice()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/order/order_invoice.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/order/order_invoice.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/order/order_invoice.tpl', $data));
        }
    }
    ...
    public function shipping()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/order/order_shipping.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/order/order_shipping.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/order/order_shipping.tpl', $data));
        }
    }
