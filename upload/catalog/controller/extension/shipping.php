...
class ControllerExtensionShipping extends Controller {
	...
	public function getList() {
		...
		if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/extension/shipping.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/extension/shipping.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/extension/shipping.tpl', $data));
        }
	}
